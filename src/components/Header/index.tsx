...
const usuario = {
  ...
  fotografia: "/images/user/user-01.png",
}
      ...
      <div className="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
        <div className="flex items-center gap-2 sm:gap-4 2xl:hidden">
          ...
          <button
            ...
            className="z-99999 block rounded-sm border border-stroke bg-white p-1.5 shadow-sm dark:border-strokedark dark:bg-boxdark 2xl:hidden"
          >
          ...
          <Link className="block flex-shrink-0 2xl:hidden" href="/">
            <Image
              width={32}
              height={32}
