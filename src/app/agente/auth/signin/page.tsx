...
export const metadata: Metadata = {
  title: "Inicio sesion agente",
  description: "pagina de Inicio sesion agente",
};
        ...
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="px-26 py-17.5 text-center">
              ...
              <p className="2xl:px-20">
                Seguimos mejorando e inovando para ofrecerte las mejores herramientas de trabajo
              </p>
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1.5 block font-medium">Inciar sesion</span>
              ...
              <form>
                ...
                <div className="mb-5">
                  {/* TODO: VOLVER A SER INPUT */}
                  {/* <input
                    type="submit"
                    value="Iniciar sesion"
                    className="w-full cursor-pointer rounded-lg border border-primary bg-primary p-4 text-white transition hover:bg-opacity-90"
                  /> */}
                  <Link href="/agente/" className="flex w-full items-center justify-center gap-3.5 rounded-lg border border-primary bg-primary text-white p-4 transition hover:bg-opacity-90">
                      Inicia sesion
                  </Link>
                </div>
